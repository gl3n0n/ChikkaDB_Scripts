...
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, total AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, 0 AS sign_and, 0 AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'reg_mig') and (carrier = 'smart')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, total AS regm_sun, 0 AS regm_pc, 0 AS sign_and, 0 AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'reg_mig') and (carrier = 'sun')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, total AS regm_pc, 0 AS sign_and, 0 AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'reg_mig') and (carrier = 'pc')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, others AS sign_and, 0 AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'login') and (carrier = 'android')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, 0 AS sign_and, others AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'login') and (carrier = 'ios')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, 0 AS sign_and, 0 AS sign_ios, others AS sign_web, 0 AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where ((type = 'login') and (carrier = 'web')) union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, 0 AS sign_and, 0 AS sign_ios, 0 AS sign_web, total AS ussd_mt, 0 AS ussd_hits from ctmv6_stats_dtl where (type = 'ussdmt') union 
select tran_dt AS tran_dt, 0 AS reg_globe, 0 AS reg_smart, 0 AS reg_sun, 0 AS reg_fb, 0 AS reg_tw, 0 AS reg_go, 0 AS reg_li, 0 AS regm_globe, 0 AS regm_smart, 0 AS regm_sun, 0 AS regm_pc, 0 AS sign_and, 0 AS sign_ios, 0 AS sign_web, 0 AS ussd_mt, total AS ussd_hits from ctmv6_stats_dtl where (type = 'ussd');
