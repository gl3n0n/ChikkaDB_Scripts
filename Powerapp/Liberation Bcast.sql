...
insert ignore into tmp_liberation_mins select phone, max(brand) brand, min(datein) from powerapp_flu.powerapp_log where datein >= '2014-11-08' and plan = 'MYVOLUME' group by phone;
insert into tmp_weekly_usage
select phone, left(datein,10) date, max(brand), count(1) hits from powerapp_log where datein >= '2014-11-03' and plan <> 'MYVOLUME' group by 1,2;
...
-- 
select phone into outfile '/tmp/BUDDY_ACTIVE_1_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'BUDDY' and user_type= '3_4';
select phone into outfile '/tmp/BUDDY_ACTIVE_2_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'BUDDY' and user_type= '5_7';
select phone into outfile '/tmp/BUDDY_INACTIVE_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'BUDDY' and user_type= '1_2';
select phone into outfile '/tmp/TNT_ACTIVE_1_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'TNT' and user_type= '3_4';
select phone into outfile '/tmp/TNT_ACTIVE_2_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'TNT' and user_type= '5_7';
select phone into outfile '/tmp/TNT_INACTIVE_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_bcast_liberation_mins where brand = 'TNT' and user_type= '1_2';
...
truncate table tmp_weekly_usage;
insert into tmp_weekly_usage
select phone, max(left(datein,10)) date, max(brand), count(1) hits from powerapp_log where datein >= '2014-11-03' and datein < '2014-11-11' and plan <> 'MYVOLUME' group by 1;
-- current
...
-- Monday Broadcast
select phone into outfile '/tmp/BUDDY_CUR_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein > '2014-11-03' and datein < '2014-11-09' and brand='BUDDY' and not exists (select 1 from tmp_bcast_liberation_mins c where a.phone = c.phone);
select phone into outfile '/tmp/TNT_CUR_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein > '2014-11-03' and datein < '2014-11-09' and brand='TNT' and not exists (select 1 from tmp_bcast_liberation_mins c where a.phone = c.phone);
select phone into outfile '/tmp/BUDDY_LAP_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein >= '2014-10-27' and datein < '2014-11-03' and brand='BUDDY' and not exists (select 1 from tmp_weekly_usage b where a.phone=b.phone) and not exists (select 1 from tmp_bcast_liberation_mins c where a.phone = c.phone);
select phone into outfile '/tmp/TNT_LAP_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein >= '2014-10-27' and datein < '2014-11-03' and brand='TNT' and not exists (select 1 from tmp_weekly_usage b where a.phone=b.phone) and not exists (select 1 from tmp_bcast_liberation_mins c where a.phone = c.phone);

-- Wednesday & Saturday Broadcast
select phone into outfile '/tmp/BUDDY_CUR_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein > '2014-11-03' and datein < '2014-11-09' and brand='BUDDY';
select phone into outfile '/tmp/TNT_CUR_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein > '2014-11-03' and datein < '2014-11-09' and brand='TNT';
select phone into outfile '/tmp/BUDDY_LAP_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein >= '2014-10-27' and datein < '2014-11-03' and brand='BUDDY' and not exists (select 1 from tmp_weekly_usage b where a.phone=b.phone);
select phone into outfile '/tmp/TNT_LAP_20141112.csv' fields terminated by ',' lines terminated by '\n' from tmp_liberation_mins a where datein >= '2014-10-27' and datein < '2014-11-03' and brand='TNT' and not exists (select 1 from tmp_weekly_usage b where a.phone=b.phone);
