...
select left(datein,10) datein, count(1) unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'UNLI' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, count(1) email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'EMAIL' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, count(1) social, 0 photo, 0 chat, 0 speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'SOCIAL' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, count(1) photo, 0 chat, 0 speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'PHOTO' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, count(1) chat, 0 speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'CHAT' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, count(1) speedboost, 0 unli_u, 0 email_u, 0 social_u, 0 photo_u, 0 chat_u, 0 speedboost_u, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'SPEEDBOOST' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, count(distinct phone) unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'UNLI' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, count(distinct phone) email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'EMAIL' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, count(distinct phone) social, 0 photo, 0 chat, 0 speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'SOCIAL' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, 0 social, count(distinct phone) photo, 0 chat, 0 speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'PHOTO' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, 0 social, 0 photo, count(distinct phone) chat, 0 speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'CHAT' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, 0 social, 0 photo, 0 chat, count(distinct phone) speedboost, 0 total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) and plan= 'SPEEDBOOST' group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, count(1) total_hits, 0 total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) group by left(datein,10) union 
select left(datein,10) datein, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 unli, 0 email, 0 social, 0 photo, 0 chat, 0 speedboost, 0 total_hits, count(distinct phone) total_uniq from powerapp_log where datein >= date_sub(curdate(), interval 7 day) group by left(datein,10);  
