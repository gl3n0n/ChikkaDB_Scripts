...
begin
   ...
   call sp_generate_15day_retention_stats(date_sub(curdate(), interval 1 day));
...
begin
   ...
   call sp_generate_active_stats(p_trandate);
end;
//
delimiter ;
...
drop procedure if exists sp_generate_15day_retention_stats;
delimiter //
