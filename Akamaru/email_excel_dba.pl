...
$strSQLPH ="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='PHILIPPINES'";	
...
$strSQLUS ="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='UNITED STATES'";	
...
$strSQLUAE ="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='UNITED ARAB EMIRATES'";	
...
$strSQLCHINA ="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='CHINA'";	
...
$strSQLUK="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='UNITED KINGDOM'";	
...
$strSQLSAUDI="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='SAUDI ARABIA'";	
...
$strSQLJPN="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='JAPAN'";	
...
$strSQLSG="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='SINGAPORE'";	
...
$strSQLMY="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='MALAYSIA'";	
...
$strSQLCAN="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='CANADA'";	
...
$strSQLAUS="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='AUSTRALIA'";	
...
$strSQLQATAR="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='QATAR'";	
...
$strSQLKOREA="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='SOUTH KOREA'";	
...
$strSQLHK="SELECT * FROM oist_countries_breakdown WHERE datein LIKE '$current_date%' AND country='HONG KONG'";	
...
$to = "mbmalano\@chikka.com,gmlenon\@chikka.com";
