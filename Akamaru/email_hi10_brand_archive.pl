...
$worksheet->merge_range('K1:S1', 'EMAIL', $format2);
$worksheet->merge_range('T1:AB1', 'PHOTO', $format2);
$worksheet->merge_range('AC1:AK1', 'UNLI', $format2);
$worksheet->merge_range('AL1:AN1', 'BOOST', $format2);
$worksheet->merge_range('AO1:AQ1', 'SOCIAL', $format2);
...
$worksheet->merge_range('K2:M2', 'SMART PREPAID', $format2);
$worksheet->merge_range('N2:P2', 'TNT', $format2);
$worksheet->merge_range('Q2:S2', 'SMART POSTPAID', $format2);
$worksheet->merge_range('T2:V2', 'SMART PREPAID', $format2);
$worksheet->merge_range('W2:Y2', 'TNT', $format2);
$worksheet->merge_range('Z2:AB2', 'SMART POSTPAID', $format2);
$worksheet->merge_range('AC2:AE2', 'SMART PREPAID', $format2);
$worksheet->merge_range('AF2:AH2', 'TNT', $format2);
$worksheet->merge_range('AI2:AK2', 'SMART POSTPAID', $format2);
$worksheet->write(1, 37, 'SMART PREPAID', $format21R);
$worksheet->write(1, 38, 'TNT', $format21R);
$worksheet->write(1, 39, 'SMART POSTPAID', $format21R);
$worksheet->write(1, 40, 'SMART PREPAID', $format21R);
$worksheet->write(1, 41, 'TNT', $format21R);
$worksheet->write(1, 42, 'SMART POSTPAID', $format21R);

$worksheet->set_column(0,0,9);
$worksheet->set_column(1,36,6);
$worksheet->set_column(37,37,15);
$worksheet->set_column(38,38,8);
$worksheet->set_column(39,39,16);
$worksheet->set_column(40,40,15);
$worksheet->set_column(41,41,8);
$worksheet->set_column(42,42,16);
...
$worksheet->write($row+$i, $col+13,   '3hours',     $format);
$worksheet->write($row+$i, $col+14,   '24hours',    $format);
$worksheet->write($row+$i, $col+15,   'TOTAL',      $format);
$worksheet->write($row+$i, $col+16,   '3hours',     $format);
$worksheet->write($row+$i, $col+17,   '24hours',    $format);
$worksheet->write($row+$i, $col+18,   'TOTAL',      $format);
$worksheet->write($row+$i, $col+19,   '3hours',     $format);
$worksheet->write($row+$i, $col+20,   '24hours',    $format);
$worksheet->write($row+$i, $col+21,   'TOTAL',      $format);
$worksheet->write($row+$i, $col+22,   '3hours',     $format);
$worksheet->write($row+$i, $col+23,   '24hours',    $format);
$worksheet->write($row+$i, $col+24,   'TOTAL',      $format);
$worksheet->write($row+$i, $col+25,   '3hours',     $format);
$worksheet->write($row+$i, $col+26,   '24hours',    $format);
$worksheet->write($row+$i, $col+27,   'TOTAL',      $format);
$worksheet->write($row+$i, $col+28,   '3hours',     $format);
$worksheet->write($row+$i, $col+29,   '24hours',    $format);
$worksheet->write($row+$i, $col+30,   'TOTAL',      $format);
...
$worksheet->write($row+$i, $col+37,   '15mins',     $format);
$worksheet->write($row+$i, $col+38,   '15mins',     $format);
$worksheet->write($row+$i, $col+39,   '15mins',     $format);
$worksheet->write($row+$i, $col+40,   'free',       $format);
$worksheet->write($row+$i, $col+41,   'free',       $format);
$worksheet->write($row+$i, $col+42,   'free',       $format);
...
while (@rowRst = $sth_hi_10->fetchrow()) {
   $i++;
   $worksheet->write($row+$i, $col+10,  $rowRst[1],  $format1);
   $worksheet->write($row+$i, $col+11,  $rowRst[2],  $format1);
   $worksheet->write($row+$i, $col+12,  $rowRst[3],  $format1);
   $worksheet->write($row+$i, $col+13,  $rowRst[4],  $format1);
   $worksheet->write($row+$i, $col+14,  $rowRst[5],  $format1);
   $worksheet->write($row+$i, $col+15,  $rowRst[6],  $format1);
   $worksheet->write($row+$i, $col+16,  $rowRst[7],  $format1);
   $worksheet->write($row+$i, $col+17,  $rowRst[8],  $format1);
   $worksheet->write($row+$i, $col+18,  $rowRst[9],  $format1);
}
...
while (@rowRst = $sth_hi_10->fetchrow()) {
   $i++;
   $worksheet->write($row+$i, $col+19,  $rowRst[1],  $format1);
   $worksheet->write($row+$i, $col+20,  $rowRst[2],  $format1);
   $worksheet->write($row+$i, $col+21,  $rowRst[3],  $format1);
   $worksheet->write($row+$i, $col+22,  $rowRst[4],  $format1);
   $worksheet->write($row+$i, $col+23,  $rowRst[5],  $format1);
   $worksheet->write($row+$i, $col+24,  $rowRst[6],  $format1);
   $worksheet->write($row+$i, $col+25,  $rowRst[7],  $format1);
   $worksheet->write($row+$i, $col+26,  $rowRst[8],  $format1);
   $worksheet->write($row+$i, $col+27,  $rowRst[9],  $format1);
}
...
while (@rowRst = $sth_hi_10->fetchrow()) {
   $i++;
   $worksheet->write($row+$i, $col+28,  $rowRst[1],  $format1);
   $worksheet->write($row+$i, $col+29,  $rowRst[2],  $format1);
   $worksheet->write($row+$i, $col+30,  $rowRst[3],  $format1);
   $worksheet->write($row+$i, $col+31,  $rowRst[4],  $format1);
   $worksheet->write($row+$i, $col+32,  $rowRst[5],  $format1);
   $worksheet->write($row+$i, $col+33,  $rowRst[6],  $format1);
   $worksheet->write($row+$i, $col+34,  $rowRst[7],  $format1);
   $worksheet->write($row+$i, $col+35,  $rowRst[8],  $format1);
   $worksheet->write($row+$i, $col+36,  $rowRst[9],  $format1);
}
...
while (@rowRst = $sth_hi_10->fetchrow()) {
   $i++;
   $worksheet->write($row+$i, $col+37,  $rowRst[3],  $format1);
   $worksheet->write($row+$i, $col+38,  $rowRst[6],  $format1);
...
while (@rowRst = $sth_hi_10->fetchrow()) {
   $i++;
   $worksheet->write($row+$i, $col+40,  $rowRst[3],  $format1);
   $worksheet->write($row+$i, $col+41,  $rowRst[6],  $format1);
   $worksheet->write($row+$i, $col+42,  $rowRst[9],  $format1);
}
