...
$strSQLhi10a = "select DATE_FORMAT(b.tran_dt,'%m/%d/%Y') tran_dt, 
                      a.buddy, a.postpd, a.tnt, a.others, a.total
               from powerapp_flu.powerapp_dailyrep b left outer join powerapp_apn_stats a on b.tran_dt = a.tran_dt
               where left(b.tran_dt,7) >= '".$current_date."' 
               order by b.tran_dt";
