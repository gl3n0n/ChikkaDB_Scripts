...
my $current_date = common::currentDate();
...
my $sth_qry_insert  = "";
my $qry_insert = "INSERT INTO oist_stat_globe (datein,sms_revenue,sms_hits,unique_charged_mins,unique_charged_post,unique_charged_pre,unique_charged_tm) 
